        ...
        <div className="grid grid-cols-4 gap-3 mb-4">
          <div className="bg-white rounded-lg border border-gray-200 p-3">
            <div className="flex items-center justify-between mb-2">
              <div className="text-[10.5px] text-gray-500">Total Templates</div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-3">
            ...
            <div className="text-2xl font-bold text-gray-900">{activeTemplates}</div>
          </div>
          <div className="bg-white rounded-lg border border-gray-200 p-3">
            <div className="flex items-center justify-between mb-2">
              <div className="text-[10.5px] text-gray-500">Total Usage</div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-3">
            <div className="flex items-center justify-between mb-2">
              <div className="text-[10.5px] text-gray-500">Categories</div>
